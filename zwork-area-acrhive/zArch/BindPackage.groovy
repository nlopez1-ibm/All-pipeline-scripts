...
/**
* This script builds a DB2 application package for SQL programs in the applicatione.  It is 
* called by the CobolCompile.groovy script.  It requires that the properties in bind.properties 
